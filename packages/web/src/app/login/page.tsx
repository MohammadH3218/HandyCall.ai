...
const PRO_FEATURES = [
  {
    ...
    desc: 'Answers in ~2 seconds with your approved scripts and pricing rules.',
  },
  {
    title: 'Real-time dashboard',
    desc: 'Transcripts, summaries, and lead capture — all in one place.',
  },
  {
    title: 'Smart scheduling',
    desc: 'Books jobs from your live calendar and sends confirmations automatically.',
  },
  {
    title: 'Automated follow-up',
    desc: 'SMS reminders and recaps keep your prospects warm without lifting a finger.',
  },
];
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      await changePassword(
        ...
        newPassword,
        passwordChangeSession!,
        passwordChangePoolType || undefined
      );
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto grid max-w-6xl items-start gap-12 px-4 pb-20 pt-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:pt-20">
        ...
        <div className="space-y-8">
          <div>
            <h1 className="text-[2.6rem] font-bold leading-[1.08] tracking-tight text-slate-900 dark:text-slate-100 md:text-5xl">
          ...
          {/* Mini context widget */}
          <div className="max-w-sm overflow-hidden rounded-2xl border border-border/80 bg-card/90 shadow-lg shadow-slate-200/20 backdrop-blur-sm">
            <div className="flex items-center justify-between bg-slate-950 px-4 py-3 dark:bg-slate-900">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-1 text-xs text-slate-400">Live call</span>
              </div>
            ...
            <div className="space-y-3 px-4 py-4 text-sm text-slate-700 dark:text-slate-300">
              {[
                ...
                {
                  role: 'HandyCall',
                  text: '"I have Thursday at 10 AM open. Does that work?"',
                  isAI: true,
                },
                ...
                <div key={i} className="flex gap-2.5">
                  <div
                    className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[10px] font-bold ${msg.isAI ? 'bg-emerald-600 text-white' : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'}`}
                  >
                    {msg.isAI ? 'H' : 'C'}
                  </div>
            ...
            <div className="border-t border-border/80 bg-emerald-50/60 px-4 py-2.5 dark:border-slate-800 dark:bg-emerald-950/30">
              <p className="text-xs font-semibold text-emerald-700 dark:text-emerald-300">
                Booked · AC tune-up · Thu 10:00 AM ✓
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-border/80 bg-card/88 p-8 shadow-[0_24px_70px_-38px_rgba(15,23,42,0.42)] backdrop-blur-sm">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Access your HandyCall pro workspace
            </p>
          </div>
          ...
          <div className="space-y-2.5">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-border/80 bg-card/75 text-sm font-medium text-slate-700 shadow-sm backdrop-blur-sm transition-all hover:bg-accent/80 dark:text-slate-200 disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form onSubmit={handlePasswordChange}>
            <div className="space-y-4 py-4">
              ...
              <p className="rounded-xl border border-border bg-card/70 px-4 py-3 text-xs text-slate-500 dark:text-slate-400">
