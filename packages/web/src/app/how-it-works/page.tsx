                ...
                return (
                  ...
                  >
                    <div className="flex-1 space-y-2">
                      <p className="text-6xl font-black text-slate-100 leading-none">{step.number}</p>
                      <h2 className="text-2xl font-bold text-slate-900 -mt-7">{step.title}</h2>
                    ...
                    <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-white shadow-sm">
                      <Icon className="h-9 w-9 text-slate-700" stroke={1.5} />
                    </div>
                  </div>
                );
              })}
                ...
                return (
                  <div key={point.title} className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm text-center">
                    <div className="flex justify-center mb-3">
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-slate-100">
        ...
        <section className="bg-slate-900 py-14 text-center">
          <div className="mx-auto max-w-xl px-4">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/find-pros"
                className="rounded-xl bg-white px-8 py-3 text-sm font-semibold text-slate-900 hover:bg-slate-100 transition"
              >
                Find a Pro Now
              </Link>
              <Link
                href="/categories"
                className="rounded-xl border border-slate-700 px-8 py-3 text-sm font-semibold text-slate-300 hover:bg-slate-800 transition"
              >
                Browse Categories
              </Link>
            </div>
