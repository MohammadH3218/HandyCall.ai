  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="mt-1 text-muted-foreground">View your past charges and download receipts.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Your payment history will appear here after you book a service.</p>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100">
                ...
                <th className="px-5 py-3 text-right font-medium text-muted-foreground">Status</th>
              ...
              {payments.map((p: any) => (
                <tr key={p.id} className="hover:bg-slate-50/50">
                  ...
                  <td className="px-2 py-4">
                    {p.receipt_url && (
                      <a href={p.receipt_url} target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-emerald-600">
