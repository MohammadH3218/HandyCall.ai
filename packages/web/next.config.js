...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "base-uri 'self'",
      "form-action 'self' https://api.moyasar.com https://checkout.moyasar.com",
      "frame-ancestors 'none'",
      "object-src 'none'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://cdn.moyasar.com",
      ...
      "frame-src https://js.stripe.com https://hooks.stripe.com https://www.google.com https://maps.google.com https://api.moyasar.com https://checkout.moyasar.com",
    ].join('; '),
  },
  ...(isProduction
    ? [
