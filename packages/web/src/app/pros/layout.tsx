        ...
        try {
          ...
          if (!hasValidAuth && !state.isLoading) {
            ...
            if (!sessionData || (!sessionData.accessToken && !sessionData.idToken)) {
              console.log('[ProsLayout] No valid credentials after checkAuth, signing out');
        ...
        <nav className="flex-1 px-4 py-5 space-y-5 overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            <NavLink
              ...
              active={pathname?.startsWith('/pros/calls')}
              onClick={() => setSidebarOpen(false)}
            >
              Calls
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/messages')}
              onClick={() => setSidebarOpen(false)}
            >
              Messages
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/customers')}
              onClick={() => setSidebarOpen(false)}
            >
              Customers
            </NavLink>
            <NavLink
              href="/pros/lead-inbox"
              icon={<Users className="h-5 w-5" />}
              active={pathname?.startsWith('/pros/lead-inbox')}
              onClick={() => setSidebarOpen(false)}
            >
              Lead Inbox
            </NavLink>
            <NavLink
              href="/pros/appointments"
              icon={<Calendar className="h-5 w-5" />}
              active={pathname?.startsWith('/pros/appointments')}
              onClick={() => setSidebarOpen(false)}
            >
              Appointments
            </NavLink>
          ...
          <div className="pt-2 border-t border-border space-y-1">
            ...
            <NavLink
              ...
              active={pathname?.startsWith('/pros/knowledge')}
              onClick={() => setSidebarOpen(false)}
            >
              Knowledge Base
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/invoices')}
              onClick={() => setSidebarOpen(false)}
            >
              Invoices
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/settings')}
              onClick={() => setSidebarOpen(false)}
            >
              Settings
            </NavLink>
          ...
          <div className="pt-2 border-t border-border space-y-1">
            ...
            <NavLink
              ...
              active={pathname?.startsWith('/pros/usage')}
              onClick={() => setSidebarOpen(false)}
            >
              Usage
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/billing')}
              onClick={() => setSidebarOpen(false)}
            >
              Billing
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/payments')}
              onClick={() => setSidebarOpen(false)}
            >
              Payments
            </NavLink>
            <NavLink
              ...
              active={pathname?.startsWith('/pros/team')}
              onClick={() => setSidebarOpen(false)}
            >
              Team
            </NavLink>
          ...
          <div className="pt-2 border-t border-border space-y-1">
            ...
            <NavLink
              ...
              active={pathname?.startsWith('/pros/analytics')}
              onClick={() => setSidebarOpen(false)}
            >
              Analytics
            </NavLink>
            <NavLink
              href="/pros/sms-automation"
              icon={<MessageSquare className="h-5 w-5" />}
              active={pathname?.startsWith('/pros/sms-automation')}
              onClick={() => setSidebarOpen(false)}
            >
              SMS Automation
            </NavLink>
            <NavLink
              href="/pros/follow-ups"
              icon={<Send className="h-5 w-5" />}
              active={pathname?.startsWith('/pros/follow-ups')}
              onClick={() => setSidebarOpen(false)}
            >
              Follow-ups
            </NavLink>
            <NavLink
              href="/pros/outbound-calls"
              icon={<PhoneOutgoing className="h-5 w-5" />}
              active={pathname?.startsWith('/pros/outbound-calls')}
              onClick={() => setSidebarOpen(false)}
            >
              Outbound Calls
            </NavLink>
